...
function useDebouncedCallback(callback, options) {
  ...
  const flushRef = (0, import_react2.useRef)(() => {
  });
...
function useMove(onChange, handlers, dir = "ltr") {
  ...
  (0, import_react24.useEffect)(() => {
    ...
    node == null ? void 0 : node.addEventListener("mousedown", onMouseDown);
    node == null ? void 0 : node.addEventListener("touchstart", onTouchStart, { passive: false });
    return () => {
      if (node) {
...
function useHover() {
  ...
  (0, import_react40.useEffect)(() => {
    ...
    if (node) {
      ...
      return () => {
        node == null ? void 0 : node.removeEventListener("mouseenter", onMouseEnter);
...
function useEventListener(type, listener, options) {
  ...
  (0, import_react45.useEffect)(() => {
    ...
    if (node) {
      ...
      return () => node == null ? void 0 : node.removeEventListener(type, listener, options);
    }
    return void 0;
  }, [listener, options]);
  return ref;
...
function useInViewport() {
  ...
  const ref = (0, import_react55.useCallback)((node) => {
    ...
    if (typeof IntersectionObserver !== "undefined") {
      ...
      if (node) {
        (_b = observer.current) == null ? void 0 : _b.observe(node);
      } else {
        setInViewport(false);
      }
    }
...
function getInitialValue2(initialValue, getInitialValueInEffect) {
  ...
  if (typeof window !== "undefined" && "screen" in window) {
    return {
      angle: ((_a = window.screen.orientation) == null ? void 0 : _a.angle) ?? initialValue.angle,
      type: ((_b = window.screen.orientation) == null ? void 0 : _b.type) ?? initialValue.type
    };
  }
  return initialValue;
}
...
function getDigitsAfterDot(value) {
  var _a;
  return ((_a = value.toString().split(".")[1]) == null ? void 0 : _a.length) || 0;
}
  ...
  (0, import_react67.useEffect)(() => {
    ...
    const update = (event, done = false) => {
      if (node) {
        ...
        onChange(newValue);
        done && (onChangeEnd == null ? void 0 : onChangeEnd(newValue));
      }
    };
    const beginTracking = () => {
      onScrubStart == null ? void 0 : onScrubStart();
      setActive(true);
    ...
    node == null ? void 0 : node.addEventListener("mousedown", onMouseDown);
    node == null ? void 0 : node.addEventListener("touchstart", handleTouchStart, { passive: false });
    return () => {
      if (node) {
        node.removeEventListener("mousedown", onMouseDown);
...
function useFileDialog(input = {}) {
  ...
  const handleChange = (0, import_react69.useCallback)(
    (event) => {
      ...
      if (target == null ? void 0 : target.files) {
        ...
        (_a = options.onChange) == null ? void 0 : _a.call(options, target.files);
      }
    },
    [options.onChange]
  );
  const createAndSetupInput = (0, import_react69.useCallback)(() => {
    var _a;
    (_a = inputRef.current) == null ? void 0 : _a.remove();
  ...
  useIsomorphicEffect(() => {
    ...
    return () => {
      var _a;
      return (_a = inputRef.current) == null ? void 0 : _a.remove();
    };
  }, []);
  const reset = (0, import_react69.useCallback)(() => {
    var _a;
    setFiles(null);
    (_a = options.onChange) == null ? void 0 : _a.call(options, null);
  }, [options.onChange]);
...
//# sourceMappingURL=chunk-3GASZLJC.js.map

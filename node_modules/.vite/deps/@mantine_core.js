...
function getRefProp(element) {
  var _a;
  const version = import_react8.default.version;
  if (typeof import_react8.default.version !== "string") {
...
function useProviderColorScheme({
  ...
  const media = (0, import_react20.useRef)(null);
  const [value, setValue] = (0, import_react20.useState)(() => manager.get(defaultColorScheme));
  const colorSchemeValue = forceColorScheme || value;
  const setColorScheme = (0, import_react20.useCallback)(
    (colorScheme) => {
      if (!forceColorScheme) {
  ...
  const clearColorScheme = (0, import_react20.useCallback)(() => {
...
function getVariantClassName({
  ...
  return (options == null ? void 0 : options.variant) && !unstyled ? classes88[`${selector}--${options.variant}`] : void 0;
}
...
function resolveVars({
  ...
  var _a;
  return (_a = mergeVars([
    headless ? {} : varsResolver91 == null ? void 0 : varsResolver91(theme, props, stylesCtx),
    ...themeName.map((name) => {
      var _a2, _b, _c;
...
function useMantineColorScheme({ keepTransitions } = {}) {
  const clearStylesRef = (0, import_react26.useRef)(noop);
  const timeoutRef = (0, import_react26.useRef)(-1);
  const ctx = (0, import_react26.useContext)(MantineContext);
  const nonce = useMantineStyleNonce();
  const nonceValue = (0, import_react26.useRef)(nonce == null ? void 0 : nonce());
  if (!ctx) {
    throw new Error("[@mantine/core] MantineProvider was not found in tree");
  }
  ...
  const toggleColorScheme = (0, import_react26.useCallback)(
...
var _Box = (0, import_react39.forwardRef)(
  ({
    ...
    return (0, import_jsx_runtime32.jsxs)(import_jsx_runtime32.Fragment, { children: [
      parsedStyleProps.hasResponsiveStyles && (0, import_jsx_runtime32.jsx)(
        InlineStyles,
        {
      ...
      typeof renderRoot === "function" ? renderRoot(props) : (0, import_jsx_runtime32.jsx)(Element2, { ...props })
    ] });
  }
);
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react40.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react40.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(Component, { ...fixedProps, ...props, ref }));
...
function polymorphicFactory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react41.forwardRef)((props, ref) => (0, import_jsx_runtime34.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
var DirectionContext = (0, import_react42.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react42.useContext)(DirectionContext);
}
function DirectionProvider({
  ...
  const [dir, setDir] = (0, import_react42.useState)(initialDirection);
  ...
  return (0, import_jsx_runtime35.jsx)(DirectionContext.Provider, { value: { dir, toggleDirection, setDirection }, children });
}
...
function useCollapse({
  ...
  const el = (0, import_react43.useRef)(null);
  const collapsedHeight = 0;
  const collapsedStyles = {
    height: 0,
    overflow: "hidden"
  };
  const [styles, setStylesRaw] = (0, import_react43.useState)(opened ? {} : collapsedStyles);
  ...
  function getCollapseProps({ style = {}, refKey = "ref", ...rest } = {}) {
    ...
    if (import_react43.default.version.startsWith("18")) {
      if (!opened) {
        props.inert = "";
      }
    } else {
...
var Collapse = factory((props, ref) => {
  ...
  if (duration === 0) {
    return opened ? (0, import_jsx_runtime36.jsx)(Box, { ...others, children }) : null;
  }
...
var index = isClient ? import_react45.useLayoutEffect : noop2;
...
function getCellIndexOfCorner(index5, sizes2, cellMap, cols, corner) {
...
var FloatingListContext = React13.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function FloatingList(props) {
  ...
  const [map, setMap] = React13.useState(() => /* @__PURE__ */ new Map());
  const register = React13.useCallback((node) => {
    setMap((prevMap) => new Map(prevMap).set(node, null));
  }, []);
  const unregister = React13.useCallback((node) => {
    setMap((prevMap) => {
  ...
  return React13.createElement(FloatingListContext.Provider, {
...
function useListItem(props) {
  ...
  const {
    ...
    elementsRef,
    labelsRef
  } = React13.useContext(FloatingListContext);
  const [index$1, setIndex] = React13.useState(null);
...
function renderJsx(render, computedProps) {
  ...
  if (render) {
    return React13.cloneElement(render, computedProps);
  }
  return React13.createElement("div", computedProps);
}
var CompositeContext = React13.createContext({
  activeIndex: 0,
  onNavigate: () => {
  }
});
...
var Composite = React13.forwardRef(function Composite2(props, forwardedRef) {
  const {
    render,
    orientation = "both",
    loop = true,
  ...
  const [internalActiveIndex, internalSetActiveIndex] = React13.useState(0);
  ...
  return React13.createElement(CompositeContext.Provider, {
    value: contextValue
  }, React13.createElement(FloatingList, {
    elementsRef
  }, renderJsx(render, computedProps)));
});
var CompositeItem = React13.forwardRef(function CompositeItem2(props, forwardedRef) {
  const {
    render,
    ...domProps
  } = props;
  ...
  const {
    activeIndex,
    onNavigate
  } = React13.useContext(CompositeContext);
  const {
    ref,
    index: index5
  } = useListItem();
...
var FloatingArrow = React13.forwardRef(function FloatingArrow2(props, ref) {
  const {
    context: {
      placement,
      elements: {
  ...
  const [isRTL2, setIsRTL] = React13.useState(false);
  index2(() => {
    if (!floating) return;
  ...
  return React13.createElement("svg", _extends({}, rest, {
    "aria-hidden": true,
    ref,
  ...
  }), computedStrokeWidth > 0 && React13.createElement("path", {
    ...
    d: dValue
  }), React13.createElement("clipPath", {
    id: clipPathId
...
function useHover(context, props) {
  ...
  const pointerTypeRef = React13.useRef();
  const timeoutRef = React13.useRef(-1);
  const handlerRef = React13.useRef();
  const restTimeoutRef = React13.useRef(-1);
  const blockMouseMoveRef = React13.useRef(true);
  const performedPointerEventsMutationRef = React13.useRef(false);
  const unbindMouseMoveRef = React13.useRef(() => {
  });
  const restTimeoutPendingRef = React13.useRef(false);
  const isHoverOpen = React13.useCallback(() => {
  ...
  const closeWithDelay = React13.useCallback(function(event, runElseBranch, reason) {
...
var FloatingDelayGroupContext = React13.createContext({
  delay: 0,
  initialDelay: 0,
  timeoutMs: 0,
  currentId: null,
...
var useDelayGroupContext = () => React13.useContext(FloatingDelayGroupContext);
function FloatingDelayGroup(props) {
  ...
  const [state, setState] = React13.useReducer((prev, next) => ({
    ...prev,
    ...next
  }), {
    delay,
  ...
  const initialCurrentIdRef = React13.useRef(null);
  const setCurrentId = React13.useCallback((currentId) => {
    setState({
      currentId
    });
  }, []);
  ...
  return React13.createElement(FloatingDelayGroupContext.Provider, {
    value: React13.useMemo(() => ({
      ...state,
      setState,
      setCurrentId
...
var FocusGuard = React13.forwardRef(function FocusGuard2(props, ref) {
  const [role, setRole] = React13.useState();
  index2(() => {
    if (isSafari()) {
      setRole("button");
    }
  ...
  return React13.createElement("span", _extends({}, props, restProps));
});
var PortalContext = React13.createContext(null);
var attr = createAttribute("portal");
var FOCUSABLE_ATTRIBUTE = "data-floating-ui-focusable";
var VisuallyHiddenDismiss = React13.forwardRef(function VisuallyHiddenDismiss2(props, ref) {
  return React13.createElement("button", _extends({}, props, {
    type: "button",
    ref,
    tabIndex: -1,
    style: HIDDEN_STYLES
...
var FloatingOverlay = React13.forwardRef(function FloatingOverlay2(props, ref) {
  const {
    lockScroll = false,
    ...rest
  } = props;
...
function useDismiss(context, props) {
  ...
  const insideReactTreeRef = React13.useRef(false);
  const endedOrStartedInsideRef = React13.useRef(false);
  const {
  ...
  const isComposingRef = React13.useRef(false);
...
function useFocus(context, props) {
  ...
  const blockFocusRef = React13.useRef(false);
  const timeoutRef = React13.useRef();
  const keyboardModalityRef = React13.useRef(true);
  React13.useEffect(() => {
    if (!enabled) return;
...
function useRole(context, props) {
  ...
  const item = React13.useCallback((_ref) => {
    let {
      active,
      selected
    } = _ref;
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = (0, import_react48.forwardRef)((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = (0, import_react48.useState)(0);
  const [height, setHeight] = (0, import_react48.useState)(0);
  ...
  return hasSize ? (0, import_jsx_runtime38.jsx)("div", { ...others, ref, style: { ...style, width, height } }) : null;
});
var ScrollAreaCorner = (0, import_react48.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
  const hasBothScrollbarsVisible = Boolean(ctx.scrollbarX && ctx.scrollbarY);
  const hasCorner = ctx.type !== "scroll" && hasBothScrollbarsVisible;
  return hasCorner ? (0, import_jsx_runtime38.jsx)(Corner, { ...props, ref }) : null;
});
...
var ScrollAreaRoot = (0, import_react49.forwardRef)((_props, ref) => {
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
var Scrollbar = (0, import_react51.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react51.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react51.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react51.useRef)("");
  ...
  (0, import_react51.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
var ScrollAreaScrollbarX = (0, import_react52.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const ctx = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react52.useState)();
...
var ScrollAreaScrollbarY = (0, import_react53.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react53.useState)();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
var ScrollAreaScrollbarVisible = (0, import_react54.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react54.useRef)(null);
  const pointerOffsetRef = (0, import_react54.useRef)(0);
  const [sizes2, setSizes] = (0, import_react54.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
var ScrollAreaScrollbarAuto = (0, import_react55.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
    const { forceMount, ...scrollbarProps } = props;
    const [visible, setVisible] = (0, import_react55.useState)(false);
...
var ScrollAreaScrollbarHover = (0, import_react56.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarScroll = (0, import_react57.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react57.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = (0, import_react58.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    ...
    return context.type === "hover" ? (0, import_jsx_runtime48.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime48.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime48.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime48.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
var Thumb = (0, import_react59.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react59.useRef)(void 0);
...
var ScrollAreaThumb = (0, import_react59.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...thumbProps } = props;
    const scrollbarContext = useScrollbarContext();
    if (forceMount || scrollbarContext.hasThumb) {
      return (0, import_jsx_runtime49.jsx)(Thumb, { ref: forwardedRef, ...thumbProps });
    }
    return null;
  }
);
...
var ScrollAreaViewport = (0, import_react60.forwardRef)(
  ({ children, style, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime50.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime50.jsx)("div", { style: { minWidth: "100%" }, ref: ctx.onContentChange, children })
      }
    );
  }
);
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react61.useState)(false);
  const [verticalThumbVisible, setVerticalThumbVisible] = (0, import_react61.useState)(false);
  const [horizontalThumbVisible, setHorizontalThumbVisible] = (0, import_react61.useState)(false);
  ...
  const localViewportRef = (0, import_react61.useRef)(null);
  ...
  return (0, import_jsx_runtime51.jsxs)(
    ScrollAreaRoot,
    {
      ...
      children: [
        ...
        (scrollbars === "xy" || scrollbars === "x") && (0, import_jsx_runtime51.jsx)(
          ScrollAreaScrollbar,
          {
            ...
            children: (0, import_jsx_runtime51.jsx)(ScrollAreaThumb, { ...getStyles2("thumb") })
          }
        ),
        (scrollbars === "xy" || scrollbars === "y") && (0, import_jsx_runtime51.jsx)(
          ScrollAreaScrollbar,
          {
            ...getStyles2("scrollbar"),
...
var ScrollAreaAutosize = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime51.jsx)(Box, { ...others, ref, style: [{ display: "flex", overflow: "auto" }, style], children: (0, import_jsx_runtime51.jsx)(Box, { style: { display: "flex", flexDirection: "column", flex: 1 }, children: (0, import_jsx_runtime51.jsx)(
    ScrollArea,
    {
      classNames,
      styles,
...
var VisuallyHidden = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime53.jsx)(Box, { component: "span", ref, ...getStyles2("root"), ...others });
});
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow3 = (0, import_react66.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
var Overlay = polymorphicFactory((_props, ref) => {
  const props = useProps("Overlay", defaultProps7, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime56.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ center, fixed }, mod], ...others, children });
});
...
var Portal = factory((props, ref) => {
  const { children, target, reuseTargetNode, ...others } = useProps("Portal", defaultProps8, props);
...
var OptionalPortal = factory(
  ({ withinPortal = true, children, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime58.jsx)(Portal, { ref, ...others, children });
  }
);
...
function Transition({
  ...
  if (transitionDuration === 0 || env2 === "test") {
    return mounted ? (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, { children: children({}) }) : keepMounted ? children({ display: "none" }) : null;
  }
  return transitionStatus === "exited" ? keepMounted ? children({ display: "none" }) : null : (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, { children: children(
    getTransitionStyles({
      transition,
...
function FocusTrap({
  ...
  return (0, import_react73.cloneElement)(children, { [refProp]: ref });
}
function FocusTrapInitialFocus(props) {
  return (0, import_jsx_runtime62.jsx)(VisuallyHidden, { tabIndex: -1, "data-autofocus": true, ...props });
}
...
var PopoverDropdown = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime63.jsx)(OptionalPortal, { ...ctx.portalProps, withinPortal: ctx.withinPortal, children: (0, import_jsx_runtime63.jsx)(
    Transition,
    {
      mounted: ctx.opened,
      ...ctx.transitionProps,
      ...
      children: (transitionStyles) => (0, import_jsx_runtime63.jsx)(FocusTrap, { active: ctx.trapFocus && ctx.opened, innerRef: mergedRef, children: (0, import_jsx_runtime63.jsxs)(
        Box,
        {
          ...accessibleProps,
          ...others,
          ...
          onKeyDownCapture: closeOnEscape(
            () => {
              ...
              (_b2 = ctx.onDismiss) == null ? void 0 : _b2.call(ctx);
            },
            {
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react76.cloneElement)(children, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react77.useState)(0);
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react79.useRef)(_opened);
  const onClose = () => {
...
function Popover(_props) {
  ...
  const props = useProps("Popover", defaultProps11, _props);
  const {
    children,
    position,
    offset: offset4,
  ...
  const arrowRef = (0, import_react81.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react81.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react81.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react81.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react81.useCallback)(
    (node) => {
  ...
  const onExited = (0, import_react81.useCallback)(() => {
    var _a2;
  ...
  const onEntered = (0, import_react81.useCallback)(() => {
    var _a2;
  ...
  return (0, import_jsx_runtime65.jsxs)(
    PopoverContextProvider,
    {
      ...
      children: [
        children,
        withOverlay && (0, import_jsx_runtime65.jsx)(
          Transition,
          {
            transition: "fade",
            ...
            children: (transitionStyles) => (0, import_jsx_runtime65.jsx)(OptionalPortal, { withinPortal, children: (0, import_jsx_runtime65.jsx)(
              Overlay,
              {
                ...overlayProps,
                ...getStyles2("overlay", {
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react83.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes7.barsLoader, className), ...others, ref, children: [
  (0, import_jsx_runtime66.jsx)("span", { className: classes7.bar }),
  (0, import_jsx_runtime66.jsx)("span", { className: classes7.bar }),
  (0, import_jsx_runtime66.jsx)("span", { className: classes7.bar })
] }));
...
var Dots = (0, import_react84.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsxs)(Box, { component: "span", className: clsx_default(classes7.dotsLoader, className), ...others, ref, children: [
  (0, import_jsx_runtime67.jsx)("span", { className: classes7.dot }),
  (0, import_jsx_runtime67.jsx)("span", { className: classes7.dot }),
  (0, import_jsx_runtime67.jsx)("span", { className: classes7.dot })
] }));
...
var Oval = (0, import_react85.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsx)(Box, { component: "span", className: clsx_default(classes7.ovalLoader, className), ...others, ref }));
...
var Loader = factory((_props, ref) => {
  const props = useProps("Loader", defaultProps12, _props);
  const {
    size: size4,
    color,
    type,
  ...
  if (children) {
    return (0, import_jsx_runtime69.jsx)(Box, { ...getStyles2("root"), ref, ...others, children });
  }
...
var ActionIconGroup = factory((_props, ref) => {
  const props = useProps("ActionIconGroup", defaultProps13, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ActionIconGroup", defaultProps13, _props);
  const getStyles2 = useStyles({
...
var ActionIconGroupSection = factory((_props, ref) => {
  const props = useProps("ActionIconGroupSection", defaultProps14, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ActionIconGroupSection", defaultProps14, _props);
  const getStyles2 = useStyles({
  ...
  return (0, import_jsx_runtime71.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var ActionIcon = polymorphicFactory((_props, ref) => {
  const props = useProps("ActionIcon", defaultProps15, _props);
  const {
    className,
    unstyled,
    variant,
  ...
  return (0, import_jsx_runtime72.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        (0, import_jsx_runtime72.jsx)(Transition, { mounted: !!loading, transition: "slide-down", duration: 150, children: (transitionStyles) => (0, import_jsx_runtime72.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime72.jsx)(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps }) }) }),
        (0, import_jsx_runtime72.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("icon"), children })
      ]
    }
  );
});
...
var CloseIcon = (0, import_react90.forwardRef)(
  ({ size: size4 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => (0, import_jsx_runtime73.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var CloseButton = polymorphicFactory((_props, ref) => {
  const props = useProps("CloseButton", defaultProps16, _props);
  const {
    iconSize,
    children,
    vars,
  ...
  return (0, import_jsx_runtime74.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        icon || (0, import_jsx_runtime74.jsx)(CloseIcon, {}),
        children
      ]
    }
  );
...
function filterFalsyChildren(children) {
  return import_react92.Children.toArray(children).filter(Boolean);
}
...
var Group = factory((_props, ref) => {
  const props = useProps("Group", defaultProps17, _props);
  const {
    classNames,
    className,
    style,
...
function useLockScroll({ opened, transitionDuration }) {
  const [shouldLockScroll, setShouldLockScroll] = (0, import_react95.useState)(opened);
  const timeout = (0, import_react95.useRef)(-1);
...
function useModal({
  ...
  const _id = useId(id);
  const [titleMounted, setTitleMounted] = (0, import_react96.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react96.useState)(false);
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBase.mjs
var ModalBase = (0, import_react97.forwardRef)(
  ({
    keepMounted,
    opened,
    onClose,
    ...
    return (0, import_jsx_runtime77.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime77.jsx)(
      ModalBaseProvider,
      {
        value: {
          opened,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseBody.mjs
var ModalBaseBody = (0, import_react99.forwardRef)(
...
var ModalBaseCloseButton = (0, import_react100.forwardRef)(
...
var ModalBaseContent = (0, import_react101.forwardRef)(
  ({ transitionProps, className, innerProps, onKeyDown, style, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime80.jsx)(
      Transition,
      {
        ...
        ...transitionProps,
        children: (transitionStyles) => (0, import_jsx_runtime80.jsx)(
          "div",
          {
            ...innerProps,
            className: clsx_default({ [classes11.inner]: !ctx.unstyled }, innerProps.className),
            children: (0, import_jsx_runtime80.jsx)(FocusTrap, { active: ctx.opened && ctx.trapFocus, innerRef: ref, children: (0, import_jsx_runtime80.jsx)(
              Paper,
              {
                ...others,
                component: "section",
...
var ModalBaseHeader = (0, import_react102.forwardRef)(
  ({ className, ...others }, ref) => {
    const ctx = useModalBaseContext();
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseOverlay.mjs
var ModalBaseOverlay = (0, import_react103.forwardRef)(
  ({ onClick, transitionProps, style, visible, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime82.jsx)(
      Transition,
      {
        ...
        ...transition,
        transition: "fade",
        children: (transitionStyles) => (0, import_jsx_runtime82.jsx)(
          Overlay,
          {
            ref,
            fixed: true,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseTitle.mjs
var ModalBaseTitle = (0, import_react105.forwardRef)(
  ({ className, ...others }, ref) => {
...
function NativeScrollArea({ children }) {
  return (0, import_jsx_runtime84.jsx)(import_jsx_runtime84.Fragment, { children });
}
...
var InputClearButton = factory((_props, ref) => {
  const props = useProps("InputClearButton", defaultProps18, _props);
  ...
  return (0, import_jsx_runtime86.jsx)(
    CloseButton,
    {
      ...
      ref,
      size: size4 || (ctx == null ? void 0 : ctx.size) || "sm",
...
var InputError = factory((_props, ref) => {
  const props = useProps("InputError", defaultProps20, _props);
  const {
    classNames,
    className,
    style,
...
var InputLabel = factory((_props, ref) => {
  const props = useProps("InputLabel", defaultProps21, _props);
  const {
    classNames,
    className,
    style,
    ...
    mod,
    ...others
  } = useProps("InputLabel", defaultProps21, props);
  const _getStyles = useStyles({
    name: ["InputWrapper", __staticSelector],
    props,
    classes: classes12,
  ...
  return (0, import_jsx_runtime90.jsxs)(
    Box,
    {
      ...
      children: [
        children,
        required && (0, import_jsx_runtime90.jsx)("span", { ...getStyles2("required"), "aria-hidden": true, children: " *" })
      ]
    }
  );
});
...
var InputPlaceholder = factory((_props, ref) => {
  const props = useProps("InputPlaceholder", defaultProps22, _props);
  const {
    classNames,
    className,
    style,
    ...
    mod,
    ...others
  } = useProps("InputPlaceholder", defaultProps22, props);
  const getStyles2 = useStyles({
...
var InputWrapper = factory((_props, ref) => {
  const props = useProps("InputWrapper", defaultProps23, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _label = label && (0, import_jsx_runtime92.jsx)(
    InputLabel,
    {
      labelElement,
      id: labelId,
  ...
  const _description = hasDescription && (0, import_jsx_runtime92.jsx)(
    InputDescription,
    {
      ...descriptionProps,
      ...sharedProps,
  ...
  const _input = (0, import_jsx_runtime92.jsx)(import_react113.Fragment, { children: inputContainer(children) }, "input");
  const _error = hasError && (0, import_react113.createElement)(
    InputError,
    {
      ...errorProps,
      ...sharedProps,
...
var Input = polymorphicFactory((_props, ref) => {
  const props = useProps("Input", defaultProps24, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime93.jsx)(InputContext, { value: { size: size4 || "sm" }, children: (0, import_jsx_runtime93.jsxs)(
    Box,
    {
      ...getStyles2("wrapper"),
      ...styleProps,
      ...
      size: size4,
      children: [
        leftSection && (0, import_jsx_runtime93.jsx)(
          "div",
          {
            ...leftSectionProps,
            "data-position": "left",
        ...
        _rightSection && (0, import_jsx_runtime93.jsx)(
          "div",
          {
            ...rightSectionProps,
            "data-position": "right",
...
function useInputProps(component, defaultProps186, _props) {
  const props = useProps(component, defaultProps186, _props);
  const {
    label,
    description,
    error: error2,
...
var InputBase = polymorphicFactory((props, ref) => {
  const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps25, props);
  return (0, import_jsx_runtime95.jsx)(Input.Wrapper, { ...wrapperProps, children: (0, import_jsx_runtime95.jsx)(Input, { ...inputProps, ...others, ref }) });
});
...
var Flex = polymorphicFactory((_props, ref) => {
  const props = useProps("Flex", defaultProps26, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime96.jsxs)(import_jsx_runtime96.Fragment, { children: [
    parsedStyleProps.hasResponsiveStyles && (0, import_jsx_runtime96.jsx)(
      InlineStyles,
      {
        selector: `.${responsiveClassName}`,
        styles: parsedStyleProps.styles,
...
function useFloatingIndicator({
  ...
  const transitionTimeout = (0, import_react118.useRef)(-1);
  const [initialized, setInitialized] = (0, import_react118.useState)(false);
  const [hidden, setHidden] = (0, import_react118.useState)(
  ...
  const targetResizeObserver = (0, import_react118.useRef)(null);
  const parentResizeObserver = (0, import_react118.useRef)(null);
...
var FloatingIndicator = factory((_props, ref) => {
  const props = useProps("FloatingIndicator", defaultProps27, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime98.jsx)(Box, { ref: mergedRef, mod: [{ initialized, hidden }, mod], ...getStyles2("root"), ...others });
});
...
var AccordionControl = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("AccordionControl", defaultProps28, props);
  const { value } = useAccordionItemContext();
  const ctx = useAccordionContext();
  const isActive = ctx.isItemActive(value);
  const shouldWrapWithHeading = typeof ctx.order === "number";
  const Heading = `h${ctx.order}`;
  const content = (0, import_jsx_runtime102.jsxs)(
    UnstyledButton,
    {
      ...others,
      ...
      children: [
        ...
        (0, import_jsx_runtime102.jsx)("span", { ...ctx.getStyles("label", { classNames, styles }), children }),
        icon && (0, import_jsx_runtime102.jsx)(
          Box,
          {
            component: "span",
  ...
  return shouldWrapWithHeading ? (0, import_jsx_runtime102.jsx)(Heading, { ...ctx.getStyles("itemTitle", { classNames, styles }), children: content }) : content;
});
...
var AccordionItem = factory((props, ref) => {
  ...
  const ctx = useAccordionContext();
  return (0, import_jsx_runtime103.jsx)(AccordionItemProvider, { value: { value }, children: (0, import_jsx_runtime103.jsx)(
    Box,
    {
      ref,
...
var AccordionPanel = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime104.jsx)(
    Collapse,
    {
      ...
      children: (0, import_jsx_runtime104.jsx)("div", { ...ctx.getStyles("content", { classNames, styles }), children })
    }
  );
});
...
var defaultProps31 = {
  ...
  variant: "default",
  chevron: (0, import_jsx_runtime105.jsx)(AccordionChevron, {})
};
...
function Accordion(_props) {
  const props = useProps("Accordion", defaultProps31, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime105.jsx)(
    AccordionProvider,
    {
      ...
      children: (0, import_jsx_runtime105.jsx)(Box, { ...getStyles2("root"), id: uid, ...others, variant, "data-accordion": true, children })
    }
  );
}
...
var varsResolver18 = createVarsResolver((_, { zIndex, position }) => ({
  root: {
    ...
    "--affix-top": getSpacing(position == null ? void 0 : position.top),
    "--affix-left": getSpacing(position == null ? void 0 : position.left),
    "--affix-bottom": getSpacing(position == null ? void 0 : position.bottom),
    "--affix-right": getSpacing(position == null ? void 0 : position.right)
  }
}));
var Affix = factory((_props, ref) => {
  const props = useProps("Affix", defaultProps32, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime106.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime106.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var Alert = factory((_props, ref) => {
  const props = useProps("Alert", defaultProps33, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime107.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime107.jsxs)("div", { ...getStyles2("wrapper"), children: [
        icon && (0, import_jsx_runtime107.jsx)("div", { ...getStyles2("icon"), children: icon }),
        (0, import_jsx_runtime107.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime107.jsx)("div", { ...getStyles2("title"), "data-with-close-button": withCloseButton || void 0, children: (0, import_jsx_runtime107.jsx)("span", { id: titleId, ...getStyles2("label"), children: title }) }),
          children && (0, import_jsx_runtime107.jsx)("div", { id: bodyId, ...getStyles2("message"), "data-variant": variant, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime107.jsx)(
          CloseButton,
          {
...
var Text = polymorphicFactory((_props, ref) => {
  const props = useProps("Text", defaultProps34, _props);
  const {
    lineClamp,
    truncate,
    inline: inline4,
...
var AngleSlider = factory((_props, ref) => {
  const props = useProps("AngleSlider", defaultProps36, _props);
  const {
    classNames,
    className,
    style,
  ...
  const handleKeyDown = (event) => {
    ...
    setValue(newValue);
    onChangeEnd == null ? void 0 : onChangeEnd(newValue);
  };
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react131.createElement)(
    "div",
    {
  ...
  return (0, import_jsx_runtime110.jsxs)(Box, { ref: useMergedRef(ref, rootRef), ...getStyles2("root", { focusable: true }), ...others, children: [
    marksItems && marksItems.length > 0 && (0, import_jsx_runtime110.jsx)("div", { ...getStyles2("marks"), children: marksItems }),
    withLabel && (0, import_jsx_runtime110.jsx)("div", { ...getStyles2("label"), children: typeof formatLabel === "function" ? formatLabel(_value) : _value }),
    ...
    (0, import_jsx_runtime110.jsx)("input", { type: "hidden", name, value: _value, ...hiddenInputProps })
  ] });
});
...
var AppShellAside = factory((_props, ref) => {
  const props = useProps("AppShellAside", defaultProps37, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellFooter = factory((_props, ref) => {
  var _a;
  const props = useProps("AppShellFooter", defaultProps38, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellHeader = factory((_props, ref) => {
  var _a;
  const props = useProps("AppShellHeader", defaultProps39, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellMain = factory((_props, ref) => {
  const props = useProps("AppShellMain", defaultProps40, _props);
...
function AppShellMediaStyles({
  ...
  return (0, import_jsx_runtime123.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
var AppShellNavbar = factory((_props, ref) => {
  const props = useProps("AppShellNavbar", defaultProps41, _props);
  const {
    classNames,
    className,
    style,
...
var AppShellSection = polymorphicFactory((_props, ref) => {
  const props = useProps("AppShellSection", defaultProps42, _props);
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react147.useState)(true);
  const resizingTimeout = (0, import_react147.useRef)(-1);
  const disabledTimeout = (0, import_react147.useRef)(-1);
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react147.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var AppShell = factory((_props, ref) => {
  const props = useProps("AppShell", defaultProps43, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime126.jsxs)(AppShellProvider, { value: { getStyles: getStyles2, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
var AspectRatio = factory((_props, ref) => {
  const props = useProps("AspectRatio", defaultProps44, _props);
  ...
  return (0, import_jsx_runtime127.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var ComboboxChevron = factory((_props, ref) => {
  const props = useProps("ComboboxChevron", defaultProps45, _props);
...
var ComboboxClearButton = (0, import_react152.forwardRef)(
  ({ size: size4, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime130.jsx)(
    Input.ClearButton,
    {
      ref,
      tabIndex: -1,
...
var ComboboxDropdownTarget = factory((props, ref) => {
  const { children, refProp } = useProps("ComboboxDropdownTarget", defaultProps47, props);
  useComboboxContext();
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime132.jsx)(Popover.Target, { ref, refProp, children });
});
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react156.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxEventsTarget", defaultProps49, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_react157.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime136.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        label && (0, import_jsx_runtime136.jsx)("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
...
var ComboboxOption = factory((_props, ref) => {
  const props = useProps("ComboboxOption", defaultProps53, _props);
  const {
    classNames,
    className,
    style,
...
var ComboboxOptions = factory((_props, ref) => {
  const props = useProps("ComboboxOptions", defaultProps54, _props);
...
var ComboboxSearch = factory((_props, ref) => {
  const props = useProps("ComboboxSearch", defaultProps55, _props);
  const {
    classNames,
    styles,
    unstyled,
...
var ComboboxTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxTarget", defaultProps56, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  const clonedElement = (0, import_react164.cloneElement)(children, {
    ...targetProps,
    ...others
  });
  return (0, import_jsx_runtime142.jsx)(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef), children: clonedElement });
});
...
function useCombobox({
  ...
  const listId = (0, import_react165.useRef)(null);
  const selectedOptionIndex = (0, import_react165.useRef)(-1);
  const searchRef = (0, import_react165.useRef)(null);
  const targetRef = (0, import_react165.useRef)(null);
  const focusSearchTimeout = (0, import_react165.useRef)(-1);
  const focusTargetTimeout = (0, import_react165.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react165.useRef)(-1);
  const openDropdown = (0, import_react165.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react165.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react165.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react165.useCallback)(() => {
  ...
  const selectOption = (0, import_react165.useCallback)(
    (index5) => {
  ...
  const selectActiveOption = (0, import_react165.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react165.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react165.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react165.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react165.useCallback)(
  ...
  const resetSelectedOption = (0, import_react165.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react165.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react165.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react165.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => searchRef.current.focus(), 0);
  }, []);
  const focusTarget = (0, import_react165.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => targetRef.current.focus(), 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react165.useCallback)(() => selectedOptionIndex.current, []);
...
function Combobox(_props) {
  const props = useProps("Combobox", defaultProps57, _props);
  const {
    classNames,
    styles,
    unstyled,
...
var InlineInput = (0, import_react167.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
    ...
    return (0, import_jsx_runtime144.jsx)(
      Box,
      {
        ...
        size: size4,
        ...others,
        children: (0, import_jsx_runtime144.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime144.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && (0, import_jsx_runtime144.jsx)(
                  Box,
                  {
                    component: labelElement,
                ...
                description && (0, import_jsx_runtime144.jsx)(Input.Description, { size: size4, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error2 && typeof error2 !== "boolean" && (0, import_jsx_runtime144.jsx)(Input.Error, { size: size4, __inheritStyles: false, ...getStyles2("error"), children: error2 })
              ] })
            ]
          }
        )
...
var CheckboxGroupContext = (0, import_react168.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react168.useContext)(CheckboxGroupContext);
...
var CheckboxCard = factory((_props, ref) => {
  const props = useProps("CheckboxCard", defaultProps58, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime146.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: (0, import_jsx_runtime146.jsx)(
    UnstyledButton,
    {
      ref,
...
function InputsGroupFieldset({ children, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime147.jsx)(import_jsx_runtime147.Fragment, { children });
  }
  return (0, import_jsx_runtime147.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup/CheckboxGroup.mjs
var defaultProps59 = {};
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps59, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime148.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime148.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime148.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return (0, import_jsx_runtime149.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: (0, import_jsx_runtime149.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return (0, import_jsx_runtime149.jsx)(CheckIcon, { ...others });
}
...
var CheckboxIndicator = factory((_props, ref) => {
  const props = useProps("CheckboxIndicator", defaultProps60, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime150.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime150.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
    }
  );
});
...
var Checkbox = factory((_props, forwardedRef) => {
  const props = useProps("Checkbox", defaultProps61, _props);
  const {
    classNames,
    className,
    style,
  ...
  const fallbackRef = (0, import_react175.useRef)(null);
  ...
  return (0, import_jsx_runtime151.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime151.jsxs)(Box, { ...getStyles2("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime151.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
      ] })
    }
  );
});
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && (0, import_jsx_runtime152.jsx)(CheckIcon, { className: classes23.optionsDropdownCheckIcon });
    const defaultContent = (0, import_jsx_runtime152.jsxs)(import_jsx_runtime152.Fragment, { children: [
      checkIconPosition === "left" && check,
      (0, import_jsx_runtime152.jsx)("span", { children: data.label }),
  ...
  const options = data.items.map((item) => (0, import_jsx_runtime152.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return (0, import_jsx_runtime152.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => (0, import_jsx_runtime152.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return (0, import_jsx_runtime152.jsx)(Combobox.Dropdown, { hidden: hidden || hiddenWhenEmpty && isEmpty, "data-composed": true, children: (0, import_jsx_runtime152.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
    withScrollArea ? (0, import_jsx_runtime152.jsx)(
      ScrollArea.Autosize,
      {
    ...
    isEmpty && nothingFoundMessage && (0, import_jsx_runtime152.jsx)(Combobox.Empty, { children: nothingFoundMessage })
  ] }) });
}
...
var Autocomplete = factory((_props, ref) => {
  const props = useProps("Autocomplete", defaultProps62, _props);
  const {
    classNames,
    styles,
    unstyled,
  ...
  const clearButton = (0, import_jsx_runtime153.jsx)(
  ...
  return (0, import_jsx_runtime153.jsxs)(
    Combobox,
    {
      ...
      ...comboboxProps,
      children: [
        (0, import_jsx_runtime153.jsx)(Combobox.Target, { autoComplete, children: (0, import_jsx_runtime153.jsx)(
          InputBase,
          {
            ref,
            ...others,
...
var AvatarGroupContext = (0, import_react177.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react177.useContext)(AvatarGroupContext);
...
var AvatarGroup = factory((_props, ref) => {
  const props = useProps("AvatarGroup", defaultProps63, _props);
  ...
  return (0, import_jsx_runtime154.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime154.jsx)(Box, { ref, ...getStyles2("group"), ...others }) });
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  const props = useProps("Avatar", defaultProps64, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [error2, setError] = (0, import_react179.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react179.useEffect)(() => setError(!src), [src]);
  return (0, import_jsx_runtime156.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error2 ? (0, import_jsx_runtime156.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime156.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime156.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
...
var BackgroundImage = polymorphicFactory((_props, ref) => {
  const props = useProps("BackgroundImage", defaultProps65, _props);
...
var Badge = polymorphicFactory((_props, ref) => {
  const props = useProps("Badge", defaultProps66, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime158.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime158.jsx)("span", { ...getStyles2("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime158.jsx)("span", { ...getStyles2("label"), children }),
        rightSection && (0, import_jsx_runtime158.jsx)("span", { ...getStyles2("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Blockquote = factory((_props, ref) => {
  const props = useProps("Blockquote", defaultProps67, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime159.jsxs)(Box, { component: "blockquote", ref, ...getStyles2("root"), ...others, children: [
    icon && (0, import_jsx_runtime159.jsx)("span", { ...getStyles2("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime159.jsx)("cite", { ...getStyles2("cite"), children: cite })
  ] });
});
...
var Breadcrumbs = factory((_props, ref) => {
  const props = useProps("Breadcrumbs", defaultProps68, _props);
  const {
    classNames,
    className,
    style,
  ...
  const items = import_react183.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react183.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index5
    }) : (0, import_react183.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react183.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime160.jsx)(Box, { ref, ...getStyles2("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  const props = useProps("Burger", defaultProps69, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime161.jsxs)(UnstyledButton, { ...getStyles2("root"), ref, ...others, children: [
    (0, import_jsx_runtime161.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles2("burger") }),
    children
  ] });
});
...
var ButtonGroup = factory((_props, ref) => {
  const props = useProps("ButtonGroup", defaultProps70, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ButtonGroup", defaultProps70, _props);
  const getStyles2 = useStyles({
    name: "ButtonGroup",
    props,
    classes: classes34,
  ...
  (theme, { radius, color, gradient, variant, autoContrast, size: size4 }) => {
    ...
    return {
      groupSection: {
        "--section-height": getSize(size4, "section-height"),
        "--section-padding-x": getSize(size4, "section-padding-x"),
        "--section-fz": (size4 == null ? void 0 : size4.includes("compact")) ? getFontSize(size4.replace("compact-", "")) : getFontSize(size4),
        "--section-radius": radius === void 0 ? void 0 : getRadius(radius),
        "--section-bg": color || variant ? colors.background : void 0,
        "--section-color": colors.color,
        "--section-bd": color || variant ? colors.border : void 0
...
var ButtonGroupSection = factory((_props, ref) => {
  const props = useProps("ButtonGroupSection", defaultProps71, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ButtonGroupSection", defaultProps71, _props);
  const getStyles2 = useStyles({
  ...
  return (0, import_jsx_runtime163.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  const props = useProps("Button", defaultProps72, _props);
  const {
    style,
    vars,
    className,
  ...
  return (0, import_jsx_runtime164.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime164.jsx)(Transition, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime164.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime164.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime164.jsxs)("span", { ...getStyles2("inner"), children: [
          leftSection && (0, import_jsx_runtime164.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime164.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("label"), children }),
          rightSection && (0, import_jsx_runtime164.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var CardSection = polymorphicFactory((_props, ref) => {
  const props = useProps("CardSection", defaultProps73, _props);
...
var Card = polymorphicFactory((_props, ref) => {
  const props = useProps("Card", defaultProps74, _props);
  ...
  const _children = import_react190.Children.toArray(children);
  const content = _children.map((child, index5) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react190.cloneElement)(child, {
  ...
  return (0, import_jsx_runtime167.jsx)(CardProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime167.jsx)(Paper, { ref, unstyled, ...getStyles2("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  const props = useProps("Center", defaultProps75, _props);
  ...
  return (0, import_jsx_runtime168.jsx)(Box, { ref, mod: [{ inline: inline4 }, mod], ...getStyles2("root"), ...others });
});
...
function ChipGroup(props) {
  ...
  return (0, import_jsx_runtime170.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children });
}
...
var Chip = factory((_props, ref) => {
  const props = useProps("Chip", defaultProps77, _props);
  const {
    classNames,
    className,
    style,
      ...
      children: [
        ...
        (0, import_jsx_runtime171.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime171.jsx)("span", { ...getStyles2("iconWrapper"), children: icon || (0, import_jsx_runtime171.jsx)(CheckIcon, { ...getStyles2("checkIcon") }) }),
              (0, import_jsx_runtime171.jsx)("span", { children })
            ]
          }
        )
      ]
...
var Code = factory((_props, ref) => {
  const props = useProps("Code", defaultProps78, _props);
  const {
    classNames,
    className,
    style,
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime173.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime173.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime173.jsx)("span", { ...getStyles2("shadowOverlay") }),
        (0, import_jsx_runtime173.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime173.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react198.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime175.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  var _a;
  const props = useProps("ColorSlider", defaultProps80, _props);
  const {
    classNames,
    className,
    style,
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react199.useState)({ y: 0, x: value / maxValue });
  const positionRef = (0, import_react199.useRef)(position);
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react199.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps81 = {};
var AlphaSlider = (0, import_react200.forwardRef)((props, ref) => {
...
var HueSlider = (0, import_react201.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react202.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
  const positionRef = (0, import_react202.useRef)(position);
  const { ref } = useMove(
    ({ x, y }) => {
      positionRef.current = { x, y };
  ...
  return (0, import_jsx_runtime179.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime179.jsx)(Thumb2, { position, ...getStyles2("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react203.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index5) => (0, import_react203.createElement)(
      ColorSwatch,
      {
    ...
    return (0, import_jsx_runtime180.jsx)(Box, { ...ctx.getStyles("swatches"), ref, ...others, children: colors });
  }
);
...
var ColorPicker = factory((_props, ref) => {
  const props = useProps("ColorPicker", defaultProps82, _props);
  const {
    classNames,
    className,
    style,
  ...
  const formatRef = (0, import_react204.useRef)(format2);
  const valueRef = (0, import_react204.useRef)("");
  const scrubTimeoutRef = (0, import_react204.useRef)(-1);
  const isScrubbingRef = (0, import_react204.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react204.useState)(parseColor(_value));
  ...
  return (0, import_jsx_runtime181.jsx)(ColorPickerProvider, { value: { getStyles: getStyles2, unstyled }, children: (0, import_jsx_runtime181.jsxs)(
    Box,
    {
      ref,
      ...getStyles2("wrapper"),
      ...
      ...others,
      children: [
        withPicker && (0, import_jsx_runtime181.jsxs)(import_jsx_runtime181.Fragment, { children: [
          ...
          (0, import_jsx_runtime181.jsxs)("div", { ...getStyles2("body"), children: [
            (0, import_jsx_runtime181.jsxs)("div", { ...getStyles2("sliders"), children: [
              (0, import_jsx_runtime181.jsx)(
                HueSlider,
                {
                  value: parsed.h,
              ...
              withAlpha && (0, import_jsx_runtime181.jsx)(
                AlphaSlider,
                {
                  value: parsed.a,
        ...
        Array.isArray(swatches) && (0, import_jsx_runtime181.jsx)(
          Swatches,
          {
            data: swatches,
            swatchesPerRow,
...
function EyeDropperIcon({ style, ...others }) {
  return (0, import_jsx_runtime182.jsxs)(
    "svg",
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime182.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime182.jsx)("path", { d: "M11 7l6 6" }),
        (0, import_jsx_runtime182.jsx)("path", { d: "M4 16l11.7 -11.7a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4l-11.7 11.7h-4v-4z" })
      ]
    }
  );
}
...
var ColorInput = factory((_props, ref) => {
  const props = useProps("ColorInput", defaultProps83, _props);
  const {
    classNames,
    styles,
    unstyled,
    ...
    swatchesPerRow,
    ...others
  } = useInputProps("ColorInput", defaultProps83, _props);
  const getStyles2 = useStyles({
    name: "ColorInput",
    props,
    classes: classes41,
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react205.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react205.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const eyeDropper = (0, import_jsx_runtime183.jsx)(
    ActionIcon,
    {
      ...eyeDropperButtonProps,
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime183.jsx)(EyeDropperIcon, { ...getStyles2("eyeDropperIcon") })
    }
  );
  ...
  return (0, import_jsx_runtime183.jsx)(
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime183.jsxs)(
        Popover,
        {
          __staticSelector: "ColorInput",
          ...
          children: [
            (0, import_jsx_runtime183.jsx)(Popover.Target, { children: (0, import_jsx_runtime183.jsx)(
              Input,
              {
                autoComplete: "off",
                ...others,
                ...
                leftSection: leftSection || (withPreview ? (0, import_jsx_runtime183.jsx)(
                  ColorSwatch,
                  {
            ...
            (0, import_jsx_runtime183.jsx)(
              Popover.Dropdown,
              {
                ...
                children: (0, import_jsx_runtime183.jsx)(
                  ColorPicker,
                  {
                    __staticSelector: "ColorInput",
                    value: _value,
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react206.useRef)(null);
  const searchRef = (0, import_react206.useRef)(null);
  const targetRef = (0, import_react206.useRef)(null);
  const focusSearchTimeout = (0, import_react206.useRef)(-1);
  const focusTargetTimeout = (0, import_react206.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react206.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
var Container = factory((_props, ref) => {
  const props = useProps("Container", defaultProps84, _props);
  ...
  return (0, import_jsx_runtime184.jsx)(Box, { ref, mod: [{ fluid }, mod], ...getStyles2("root"), ...others });
});
...
function CopyButton(props) {
  const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps85, props);
  const clipboard = useClipboard({ timeout });
  const copy = () => clipboard.copy(value);
  return (0, import_jsx_runtime185.jsx)(import_jsx_runtime185.Fragment, { children: children({ copy, copied: clipboard.copied, ...others }) });
}
...
var Dialog = factory((_props, ref) => {
  const props = useProps("Dialog", defaultProps86, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime186.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime186.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime186.jsxs)(
        Paper,
        {
          unstyled,
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime186.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles2("closeButton") }),
            children
          ]
        }
      ) })
...
var Divider = factory((_props, ref) => {
  const props = useProps("Divider", defaultProps87, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime187.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime187.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles2("label"), children: label })
    }
  );
});
...
var DrawerBody = factory((_props, ref) => {
  const props = useProps("DrawerBody", defaultProps88, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
...
var DrawerCloseButton = factory((_props, ref) => {
  const props = useProps("DrawerCloseButton", defaultProps89, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var DrawerContent = factory((_props, ref) => {
  const props = useProps("DrawerContent", defaultProps90, _props);
  ...
  return (0, import_jsx_runtime191.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime191.jsx)(Scroll, { style: { height: "calc(100vh - var(--drawer-offset) * 2)" }, children })
    }
  );
});
...
var DrawerHeader = factory((_props, ref) => {
  const props = useProps("DrawerHeader", defaultProps91, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var DrawerOverlay = factory((_props, ref) => {
  const props = useProps("DrawerOverlay", defaultProps92, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var DrawerRoot = factory((_props, ref) => {
  const props = useProps("DrawerRoot", defaultProps93, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime194.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius }, children: (0, import_jsx_runtime194.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react218.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react218.useState)(getDefaultZIndex("modal"));
...
var DrawerTitle = factory((_props, ref) => {
  const props = useProps("DrawerTitle", defaultProps94, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var Drawer = factory((_props, ref) => {
  const {
    ...
    zIndex,
    ...others
  } = useProps("Drawer", defaultProps95, _props);
  ...
  return (0, import_jsx_runtime197.jsxs)(
    DrawerRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime197.jsx)(
          DrawerOverlay,
          {
        ...
        (0, import_jsx_runtime197.jsxs)(DrawerContent, { __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false, children: [
          hasHeader && (0, import_jsx_runtime197.jsxs)(DrawerHeader, { children: [
            title && (0, import_jsx_runtime197.jsx)(DrawerTitle, { children: title }),
            withCloseButton && (0, import_jsx_runtime197.jsx)(DrawerCloseButton, { ...closeButtonProps })
          ] }),
          (0, import_jsx_runtime197.jsx)(DrawerBody, { children })
        ] })
      ]
    }
  );
...
var Fieldset = factory((_props, ref) => {
  const props = useProps("Fieldset", defaultProps96, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime198.jsxs)(
    Box,
    {
      component: "fieldset",
      ref,
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime198.jsx)("legend", { ...getStyles2("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var FileButton = (0, import_react222.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
      ...
      inputProps,
      ...others
    } = useProps("FileButton", defaultProps97, props);
    const inputRef = (0, import_react222.useRef)(null);
    const onClick = () => {
      var _a;
...
var DefaultValue = ({ value }) => (0, import_jsx_runtime200.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value == null ? void 0 : value.name });
var defaultProps98 = {
  valueComponent: DefaultValue
};
var _FileInput = factory((_props, ref) => {
  const props = useProps("FileInput", defaultProps98, _props);
  const {
    unstyled,
    vars,
    onChange,
  ...
  const resetRef = (0, import_react223.useRef)(null);
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi({
    classNames,
    styles,
    props
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? (0, import_jsx_runtime200.jsx)(
    CloseButton,
    {
      ...clearButtonProps,
      variant: "subtle",
  ...
  return (0, import_jsx_runtime200.jsx)(
    FileButton,
    {
      ...
      children: (fileButtonProps) => (0, import_jsx_runtime200.jsx)(
        InputBase,
        {
          ...
          classNames,
          styles,
          children: !hasValue ? (0, import_jsx_runtime200.jsx)(
            Input.Placeholder,
            {
              __staticSelector: "FileInput",
              classNames: resolvedClassNames,
          ...
          ) : (0, import_jsx_runtime200.jsx)(ValueComponent, { value: _value })
        }
      )
    }
  );
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react224.useRef)(-1);
  const closeTimeout = (0, import_react224.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react224.useEffect)(() => clearTimeouts, []);
...
var GridCol = factory((_props, ref) => {
  const props = useProps("GridCol", defaultProps99, _props);
...
var Grid = factory((_props, ref) => {
  const props = useProps("Grid", defaultProps100, _props);
  const {
    classNames,
    className,
    style,
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime205.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
      (0, import_jsx_runtime205.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime205.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime205.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime205.jsx)("div", { ...getStyles2("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime205.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
    (0, import_jsx_runtime205.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime205.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime205.jsx)("div", { ...getStyles2("inner"), children }) })
  ] });
});
...
var Mark = factory((_props, ref) => {
  const props = useProps("Mark", defaultProps101, _props);
  ...
  return (0, import_jsx_runtime207.jsx)(Box, { component: "mark", ref, variant, ...getStyles2("root"), ...others });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime208.jsx)(Text, { unstyled, ref, ...others, __staticSelector: "Highlight", children: highlightChunks.map(
    ({ chunk, highlighted }, i) => highlighted ? (0, import_jsx_runtime208.jsx)(
      Mark,
      {
        unstyled,
        color,
      ...
      i
    ) : (0, import_jsx_runtime208.jsx)("span", { children: chunk }, i)
  ) });
});
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime210.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children });
}
...
var HoverCardTarget = (0, import_react235.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime211.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react235.cloneElement)(
    children,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime212.jsx)(HoverCardContextProvider, { value: { openDropdown, closeDropdown }, children: (0, import_jsx_runtime212.jsx)(Popover, { ...others, opened, __staticSelector: "HoverCard", children }) });
}
...
var Image = polymorphicFactory((_props, ref) => {
  const props = useProps("Image", defaultProps106, _props);
  const {
    classNames,
    className,
    style,
...
var Indicator = factory((_props, ref) => {
  const props = useProps("Indicator", defaultProps107, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime215.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline4 }, mod], ...others, children: [
    !disabled && (0, import_jsx_runtime215.jsx)(
      Box,
      {
...
var index3 = import_react241.useLayoutEffect;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = import_react242.default.useRef(value);
  index3(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react243.default.useRef();
  return import_react243.default.useCallback(function(instance) {
...
var TextareaAutosize = function TextareaAutosize2(_ref, userRef) {
  ...
  };
  {
    ...
    return React16.createElement("textarea", _extends2({}, props, {
      onChange: handleChange,
      ref
    }));
  }
};
var index4 = React16.forwardRef(TextareaAutosize);
...
var JsonInput = factory((props, ref) => {
  const {
    ...
    error: error2,
    ...others
  } = useProps("JsonInput", defaultProps109, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const [valid, setValid] = (0, import_react245.useState)(validateJson(_value, deserialize));
...
var Kbd = factory((_props, ref) => {
  const props = useProps("Kbd", defaultProps110, _props);
  const { classNames, className, style, styles, unstyled, vars, ...others } = props;
  const getStyles2 = useStyles({
    name: "Kbd",
    classes: classes51,
  ...
  return (0, import_jsx_runtime218.jsx)(Box, { component: "kbd", ref, ...getStyles2("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  const props = useProps("ListItem", defaultProps111, _props);
  ...
  return (0, import_jsx_runtime220.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime220.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        _icon && (0, import_jsx_runtime220.jsx)("span", { ...ctx.getStyles("itemIcon", stylesApiProps), children: _icon }),
        (0, import_jsx_runtime220.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children })
      ] })
    }
  );
});
...
var List = factory((_props, ref) => {
  const props = useProps("List", defaultProps112, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime221.jsx)(ListProvider, { value: { center, icon, getStyles: getStyles2 }, children: (0, import_jsx_runtime221.jsx)(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  const props = useProps("LoadingOverlay", defaultProps113, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _overlayProps = { ...defaultProps113.overlayProps, ...overlayProps };
  return (0, import_jsx_runtime222.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible, children: (transitionStyles) => (0, import_jsx_runtime222.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime222.jsx)(Loader, { ...getStyles2("loader"), unstyled, ...loaderProps }),
...
var MenuDropdown = factory((props, ref) => {
  const {
    ...
    children,
    ...others
  } = useProps("MenuDropdown", defaultProps115, props);
  const wrapperRef = (0, import_react253.useRef)(null);
  const ctx = useMenuContext();
  ...
  return (0, import_jsx_runtime225.jsxs)(
    Popover.Dropdown,
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        ctx.withInitialFocusPlaceholder && (0, import_jsx_runtime225.jsx)("div", { tabIndex: -1, "data-autofocus": true, "data-mantine-stop-propagation": true, style: { outline: 0 } }),
        children
      ]
    }
  );
...
var MenuItem = polymorphicFactory((props, ref) => {
  const {
    ...
    "data-disabled": dataDisabled,
    ...others
  } = useProps("MenuItem", defaultProps116, props);
  const ctx = useMenuContext();
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react254.useRef)(null);
  ...
  return (0, import_jsx_runtime226.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime226.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime226.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        rightSection && (0, import_jsx_runtime226.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var MenuTarget = (0, import_react256.forwardRef)((props, ref) => {
  const { children, refProp, ...others } = useProps("MenuTarget", defaultProps118, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime228.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react256.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  const props = useProps("Menu", defaultProps119, _props);
  const {
    children,
    onOpen,
    onClose,
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react257.useState)(false);
  const close = () => {
    setOpened(false);
  ...
  return (0, import_jsx_runtime229.jsx)(
    MenuContextProvider,
    {
      ...
      children: (0, import_jsx_runtime229.jsx)(
        Popover,
        {
          ...others,
          opened: _opened,
...
var ModalBody = factory((_props, ref) => {
  const props = useProps("ModalBody", defaultProps120, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
...
var ModalCloseButton = factory((_props, ref) => {
  const props = useProps("ModalCloseButton", defaultProps121, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalContent = factory((_props, ref) => {
  const props = useProps("ModalContent", defaultProps122, _props);
  ...
  return (0, import_jsx_runtime233.jsx)(
    ModalBaseContent,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime233.jsx)(
        Scroll,
        {
          style: {
...
var ModalHeader = factory((_props, ref) => {
  const props = useProps("ModalHeader", defaultProps123, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalOverlay = factory((_props, ref) => {
  const props = useProps("ModalOverlay", defaultProps124, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalRoot = factory((_props, ref) => {
  const props = useProps("ModalRoot", defaultProps125, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime236.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2, fullScreen }, children: (0, import_jsx_runtime236.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react266.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react266.useState)(getDefaultZIndex("modal"));
...
var ModalTitle = factory((_props, ref) => {
  const props = useProps("ModalTitle", defaultProps126, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
  return (0, import_jsx_runtime238.jsx)(
    ModalBaseTitle,
    {
      ref,
      ...ctx.getStyles("title", { classNames, style, styles, className }),
...
var Modal = factory((_props, ref) => {
  const {
    ...
    zIndex,
    ...others
  } = useProps("Modal", defaultProps127, _props);
  ...
  return (0, import_jsx_runtime239.jsxs)(
    ModalRoot,
    {
      ref,
      radius,
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime239.jsx)(
          ModalOverlay,
          {
            visible: overlayVisible,
            transitionProps: ctx && stackId ? { duration: 0 } : void 0,
        ...
        (0, import_jsx_runtime239.jsxs)(
          ModalContent,
          {
            radius,
            __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false,
            children: [
              hasHeader && (0, import_jsx_runtime239.jsxs)(ModalHeader, { children: [
                title && (0, import_jsx_runtime239.jsx)(ModalTitle, { children: title }),
                withCloseButton && (0, import_jsx_runtime239.jsx)(ModalCloseButton, { ...closeButtonProps })
              ] }),
              (0, import_jsx_runtime239.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react269.useState)(initialState);
  const open = (0, import_react269.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react269.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react269.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react269.useCallback)(() => setState(initialState), []);
  const register = (0, import_react269.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
var PillGroup = factory((_props, ref) => {
  const props = useProps("PillGroup", defaultProps128, _props);
  ...
  return (0, import_jsx_runtime242.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime242.jsx)(Box, { ref, size: _size, ...getStyles2("group"), ...others }) });
});
...
var Pill = factory((_props, ref) => {
  const props = useProps("Pill", defaultProps129, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime243.jsxs)(
    Box,
    {
      component: "span",
      ref,
      ...
      ...others,
      children: [
        (0, import_jsx_runtime243.jsx)("span", { ...getStyles2("label"), children }),
        withRemoveButton && (0, import_jsx_runtime243.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
var PillsInputField = factory((_props, ref) => {
  const props = useProps("PillsInputField", defaultProps130, _props);
  const {
    classNames,
    className,
    style,
...
var PillsInput = factory((_props, ref) => {
  const props = useProps("PillsInput", defaultProps131, _props);
  const {
    children,
    onMouseDown,
    onClick,
  ...
  const fieldRef = (0, import_react275.useRef)(null);
  return (0, import_jsx_runtime245.jsx)(PillsInputProvider, { value: { fieldRef, size: size4, disabled, hasError: !!error2, variant }, children: (0, import_jsx_runtime245.jsx)(
    InputBase,
    {
      size: size4,
      error: error2,
...
var MultiSelect = factory((_props, ref) => {
  const props = useProps("MultiSelect", defaultProps132, _props);
  const {
    classNames,
    className,
    style,
  ...
  const clearButton = (0, import_jsx_runtime247.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime247.jsxs)(import_jsx_runtime247.Fragment, { children: [
    (0, import_jsx_runtime247.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime247.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime247.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "MultiSelect",
              ...
              disabled,
              radius,
              __defaultRightSection: (0, import_jsx_runtime247.jsx)(
                Combobox.Chevron,
                {
                  size: size4,
                  error: error2,
              ...
              required,
              mod,
              children: (0, import_jsx_runtime247.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime247.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime247.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => (0, import_jsx_runtime248.jsx)(NativeSelectOption, { data: item }, item.value));
    return (0, import_jsx_runtime248.jsx)("optgroup", { label: data.group, children: items });
  }
  const { value, label, ...others } = data;
  return (0, import_jsx_runtime248.jsx)("option", { value: data.value, ...others, children: data.label }, data.value);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index5) => (0, import_jsx_runtime249.jsx)(NativeSelectOption, { data: item }, index5));
  return (0, import_jsx_runtime249.jsx)(
    InputBase,
    {
      ...
      error: error2,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime249.jsx)(ComboboxChevron, { size: size4, error: error2, unstyled }),
...
var NavLink = polymorphicFactory((_props, ref) => {
  const props = useProps("NavLink", defaultProps134, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime250.jsxs)(import_jsx_runtime250.Fragment, { children: [
    (0, import_jsx_runtime250.jsxs)(
      UnstyledButton,
      {
        ...getStyles2("root"),
        component: "a",
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime250.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime250.jsxs)(Box, { ...getStyles2("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime250.jsx)(Box, { component: "span", ...getStyles2("label"), children: label }),
            (0, import_jsx_runtime250.jsx)(Box, { component: "span", mod: { active }, ...getStyles2("description"), children: description })
          ] }),
          (withChildren || rightSection !== void 0) && (0, import_jsx_runtime250.jsx)(
            Box,
            {
              ...getStyles2("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection !== void 0 ? rightSection : (0, import_jsx_runtime250.jsx)(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime250.jsx)(Collapse, { in: _opened, ...getStyles2("collapse"), children: (0, import_jsx_runtime250.jsx)("div", { ...getStyles2("children"), children }) })
  ] });
});
...
var Notification = factory((_props, ref) => {
  const props = useProps("Notification", defaultProps135, _props);
  const {
    className,
    color,
    radius,
  ...
  return (0, import_jsx_runtime251.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      ...
      ...others,
      children: [
        icon && !loading && (0, import_jsx_runtime251.jsx)("div", { ...getStyles2("icon"), children: icon }),
        loading && (0, import_jsx_runtime251.jsx)(Loader, { size: 28, color, ...loaderProps, ...getStyles2("loader") }),
        (0, import_jsx_runtime251.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime251.jsx)("div", { ...getStyles2("title"), children: title }),
          (0, import_jsx_runtime251.jsx)(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title }, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime251.jsx)(
          CloseButton,
          {
            iconSize: 16,
            color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react281.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react281.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  if (onValueChange === void 0) onValueChange = noop6;
  ...
  var ref = (0, import_react281.useState)(function() {
  ...
  (0, import_react281.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  if (onChange === void 0) onChange = noop6;
  var onKeyDown = props.onKeyDown;
  if (onKeyDown === void 0) onKeyDown = noop6;
  var onMouseUp = props.onMouseUp;
  if (onMouseUp === void 0) onMouseUp = noop6;
  var onFocus = props.onFocus;
  if (onFocus === void 0) onFocus = noop6;
  var onBlur = props.onBlur;
  if (onBlur === void 0) onBlur = noop6;
  ...
  var caretPositionBeforeChange = (0, import_react281.useRef)();
  var lastUpdatedValue = (0, import_react281.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react281.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react281.useRef)(null);
  var timeout = (0, import_react281.useRef)({
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react281.useLayoutEffect : import_react281.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react281.default.createElement(import_react281.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react281.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react281.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react281.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react281.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  const props = useProps("NumberFormatter", defaultProps136, _props);
  const { value, defaultValue, ...others } = props;
  if (value === void 0) {
    return null;
  }
  return (0, import_jsx_runtime252.jsx)(NumericFormat, { displayType: "text", value, ...others });
}
...
function NumberInputChevron({ direction, style, ...others }) {
  return (0, import_jsx_runtime253.jsx)(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      ...others,
      children: (0, import_jsx_runtime253.jsx)(
        "path",
        {
          d: "M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",
          fill: "currentColor",
...
var NumberInput = factory((_props, ref) => {
  const props = useProps("NumberInput", defaultProps137, _props);
  const {
    className,
    classNames,
    styles,
  ...
  const inputRef = (0, import_react283.useRef)(null);
  const onStepTimeoutRef = (0, import_react283.useRef)(null);
  const stepCountRef = (0, import_react283.useRef)(0);
  ...
  const incrementRef = (0, import_react283.useRef)(noop);
  ...
  const decrementRef = (0, import_react283.useRef)(noop);
  ...
  const controls = (0, import_jsx_runtime254.jsxs)("div", { ...getStyles2("controls"), children: [
    (0, import_jsx_runtime254.jsx)(
      UnstyledButton,
      {
        ...getStyles2("control"),
        tabIndex: -1,
        ...
        children: (0, import_jsx_runtime254.jsx)(NumberInputChevron, { direction: "up" })
      }
    ),
    (0, import_jsx_runtime254.jsx)(
      UnstyledButton,
      {
        ...
        onPointerUp: onStepDone,
        onPointerLeave: onStepDone,
        children: (0, import_jsx_runtime254.jsx)(NumberInputChevron, { direction: "down" })
      }
    )
  ] });
...
var PaginationControl = factory((_props, ref) => {
  const props = useProps("PaginationControl", defaultProps138, _props);
  const {
    classNames,
    className,
    style,
...
function PaginationIcon({ style, children, path, ...others }) {
  return (0, import_jsx_runtime257.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime257.jsx)("path", { d: path, fill: "currentColor" })
    }
  );
}
var PaginationNextIcon = (props) => (0, import_jsx_runtime257.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => (0, import_jsx_runtime257.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => (0, import_jsx_runtime257.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => (0, import_jsx_runtime257.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => (0, import_jsx_runtime257.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  const props = useProps("PaginationDots", defaultProps139, _props);
  const { classNames, className, style, styles, vars, icon, ...others } = props;
  const ctx = usePaginationContext();
  const Icon = icon;
  return (0, import_jsx_runtime258.jsx)(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others, children: (0, import_jsx_runtime258.jsx)(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  const defaultProps186 = { icon };
  const Component = (0, import_react287.forwardRef)((props, ref) => {
    const { icon: _icon, ...others } = useProps(name, defaultProps186, props);
    const Icon = _icon;
    const ctx = usePaginationContext();
    ...
    return (0, import_jsx_runtime259.jsx)(
      PaginationControl,
      {
        ...
        withPadding: false,
        ...others,
        children: (0, import_jsx_runtime259.jsx)(
          Icon,
          {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index5) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime260.jsx)(PaginationDots, { icon: dotsIcon }, index5);
    }
  ...
  return (0, import_jsx_runtime260.jsx)(import_jsx_runtime260.Fragment, { children: items });
}
...
var PaginationRoot = factory((_props, ref) => {
  const props = useProps("PaginationRoot", defaultProps140, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime261.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime261.jsx)(Box, { ref, ...getStyles2("root"), ...others })
    }
  );
});
...
var Pagination = factory((_props, ref) => {
  const props = useProps("Pagination", defaultProps141, _props);
  const {
    withEdges,
    withControls,
    getControlProps,
  ...
  return (0, import_jsx_runtime262.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime262.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime262.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }),
    withControls && (0, import_jsx_runtime262.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }),
    withPages && (0, import_jsx_runtime262.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime262.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }),
    withEdges && (0, import_jsx_runtime262.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })
  ] }) });
});
...
var PasswordInput = factory((_props, ref) => {
  const props = useProps("PasswordInput", defaultProps142, _props);
  const {
    classNames,
    className,
    style,
  ...
  const errorId = (errorProps == null ? void 0 : errorProps.id) || `${uuid}-error`;
  const descriptionId = (descriptionProps == null ? void 0 : descriptionProps.id) || `${uuid}-description`;
  const hasError = !!error2 && typeof error2 !== "boolean";
  const hasDescription = !!description;
  const _describedBy = `${hasError ? errorId : ""} ${hasDescription ? descriptionId : ""}`;
  const describedBy = _describedBy.trim().length > 0 ? _describedBy.trim() : void 0;
  const visibilityToggleButton = (0, import_jsx_runtime264.jsx)(
    ActionIcon,
    {
      ...
      children: (0, import_jsx_runtime264.jsx)(VisibilityToggleIcon, { reveal: _visible })
    }
  );
  return (0, import_jsx_runtime264.jsx)(
    Input.Wrapper,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime264.jsx)(
        Input,
        {
          component: "div",
          error: error2,
...
var varsResolver65 = createVarsResolver((_, { size: size4 }) => ({
  root: {
    "--pin-input-size": getSize(size4 ?? defaultProps143.size, "pin-input-size")
  }
}));
var PinInput = factory((props, ref) => {
  const {
    ...
    getInputProps,
    ...others
  } = useProps("PinInput", defaultProps143, props);
  const uuid = useId(id);
  const getStyles2 = useStyles({
    name: "PinInput",
    classes: classes63,
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react291.useState)(-1);
  ...
  const inputsRef = (0, import_react291.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...others,
        ...getStyles2("root"),
        ...
        __size: size4,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react291.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
            ...
            "aria-label": ariaLabel,
            readOnly,
            ...getInputProps == null ? void 0 : getInputProps(index5)
          }
        ))
      }
    ),
    (0, import_jsx_runtime265.jsx)("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps })
  ] });
});
...
var ProgressRoot = factory((_props, ref) => {
  const props = useProps("ProgressRoot", defaultProps145, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime268.jsx)(ProgressProvider, { value: { getStyles: getStyles2, autoContrast }, children: (0, import_jsx_runtime268.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var ProgressSection = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("ProgressSection", defaultProps146, props);
  const ctx = useProgressContext();
  const theme = useMantineTheme();
  const ariaAttributes = withAria ? {
    role: "progressbar",
...
var Progress = factory((_props, ref) => {
  const props = useProps("Progress", defaultProps147, _props);
  const {
    value,
    classNames,
    styles,
  ...
  return (0, import_jsx_runtime270.jsx)(
    ProgressRoot,
    {
      ...
      vars,
      ...others,
      children: (0, import_jsx_runtime270.jsx)(
        ProgressSection,
        {
          value,
          color,
...
var RadioCard = factory((_props, ref) => {
  const props = useProps("RadioCard", defaultProps148, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime273.jsx)(RadioCardProvider, { value: { checked: _checked }, children: (0, import_jsx_runtime273.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps149, props);
  ...
  return (0, import_jsx_runtime274.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size4, name: _name }, children: (0, import_jsx_runtime274.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime274.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size4, style, ...others }) {
  return (0, import_jsx_runtime275.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: (0, import_jsx_runtime275.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
var RadioIndicator = factory((_props, ref) => {
  const props = useProps("RadioIndicator", defaultProps150, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime276.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime276.jsx)(Icon, { ...getStyles2("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  const props = useProps("Radio", defaultProps151, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime277.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime277.jsxs)(Box, { ...getStyles2("inner"), mod: { "label-position": labelPosition }, children: [
        (0, import_jsx_runtime277.jsx)(
          Box,
          {
        ...
        (0, import_jsx_runtime277.jsx)(Icon, { ...getStyles2("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
function StarIcon(props) {
  ...
  return (0, import_jsx_runtime279.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime279.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return (0, import_jsx_runtime280.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  const { dir } = useDirection();
  return (0, import_jsx_runtime281.jsxs)(import_jsx_runtime281.Fragment, { children: [
    !readOnly && (0, import_jsx_runtime281.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
    ...
    (0, import_jsx_runtime281.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime281.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || (0, import_jsx_runtime281.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || (0, import_jsx_runtime281.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
var Rating = factory((_props, ref) => {
  const props = useProps("Rating", defaultProps152, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react306.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react306.useState)(-1);
  const [isOutside, setOutside] = (0, import_react306.useState)(true);
  ...
  return (0, import_jsx_runtime282.jsx)(RatingProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime282.jsx)(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react307.useState)(defaultOpened);
  const boundaryRef = (0, import_react307.useRef)(null);
  ...
  const handleMouseMove = (0, import_react307.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  const props = useProps("TooltipFloating", defaultProps153, _props);
  const {
    children,
    refProp,
    withinPortal,
  ...
  return (0, import_jsx_runtime283.jsxs)(import_jsx_runtime283.Fragment, { children: [
    (0, import_jsx_runtime283.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime283.jsx)(
      Box,
      {
        ...others,
        ...getStyles2("tooltip", {
    ...
    (0, import_react309.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react310.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react310.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  const { openDelay, closeDelay, children } = useProps("TooltipGroup", defaultProps154, props);
  return (0, import_jsx_runtime284.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime284.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react313.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react313.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  const props = useProps("Tooltip", defaultProps155, _props);
  const {
    children,
    position,
    refProp,
    ...
    middlewares,
    ...others
  } = useProps("Tooltip", defaultProps155, props);
  const { dir } = useDirection();
  const arrowRef = (0, import_react315.useRef)(null);
  ...
  const _childrenProps = children.props;
  return (0, import_jsx_runtime285.jsxs)(import_jsx_runtime285.Fragment, { children: [
    (0, import_jsx_runtime285.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime285.jsx)(
      Transition,
      {
        ...transition,
        keepMounted,
        ...
        children: (transitionStyles) => (0, import_jsx_runtime285.jsxs)(
          Box,
          {
            ...others,
    ...
    (0, import_react315.cloneElement)(
      children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return (0, import_jsx_runtime286.jsx)(Tooltip.Floating, { disabled: !tooltip, label: tooltip, children: (0, import_jsx_runtime286.jsx)(
    Box,
    {
      component: "circle",
      ...others,
...
var RingProgress = factory((_props, ref) => {
  const props = useProps("RingProgress", defaultProps156, _props);
  const {
    classNames,
    className,
    style,
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset4 }, index5) => (0, import_react318.createElement)(
    Curve,
    {
      ...data,
      key: index5,
  ...
  return (0, import_jsx_runtime287.jsxs)(Box, { ...getStyles2("root"), size: size4, ref, ...others, children: [
    (0, import_jsx_runtime287.jsx)("svg", { ...getStyles2("svg"), children: curves }),
    label && (0, import_jsx_runtime287.jsx)("div", { ...getStyles2("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  var _a, _b;
  const props = useProps("SegmentedControl", defaultProps157, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [key, setKey] = (0, import_react319.useState)(randomId());
  const [parent, setParent] = (0, import_react319.useState)(null);
  const [refs, setRefs] = (0, import_react319.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react319.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react319.createElement)(
      "input",
      {
        ...getStyles2("input"),
    ...
    (0, import_react319.createElement)(
      ...
      (0, import_jsx_runtime288.jsx)("span", { ...getStyles2("innerLabel"), children: item.label })
    )
  ));
  ...
  return (0, import_jsx_runtime288.jsxs)(
    Box,
    {
      ...
      children: [
        typeof _value === "string" && (0, import_jsx_runtime288.jsx)(
          FloatingIndicator,
          {
            target: refs[_value],
            parent,
...
var Select = factory((_props, ref) => {
  const props = useProps("Select", defaultProps158, _props);
  const {
    classNames,
    styles,
    unstyled,
  ...
  const parsedData = (0, import_react320.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react320.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
  ...
  (0, import_react320.useEffect)(() => {
    ...
    if (!controlled && !searchControlled) {
      handleSearchChange(typeof _value === "string" ? ((_a = optionsLockup[_value]) == null ? void 0 : _a.label) || "" : "");
    }
  }, [data, _value]);
  const clearButton = (0, import_jsx_runtime289.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime289.jsxs)(import_jsx_runtime289.Fragment, { children: [
    (0, import_jsx_runtime289.jsxs)(
      Combobox,
      {
        store: combobox,
        ...
        onOptionSubmit: (val) => {
          ...
          !controlled && handleSearchChange(typeof nextValue === "string" ? (optionLockup == null ? void 0 : optionLockup.label) || "" : "");
          combobox.closeDropdown();
        },
        size: size4,
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime289.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: (0, import_jsx_runtime289.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              __defaultRightSection: (0, import_jsx_runtime289.jsx)(
                Combobox.Chevron,
                {
                  size: size4,
                  error: error2,
              ...
              onBlur: (event) => {
                ...
                handleSearchChange(_value != null ? ((_a = optionsLockup[_value]) == null ? void 0 : _a.label) || "" : "");
                onBlur == null ? void 0 : onBlur(event);
              },
              onClick: (event) => {
...
var SemiCircleProgress = factory((_props, ref) => {
  const props = useProps("SemiCircleProgress", defaultProps159, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime290.jsxs)(Box, { ref, size: size4, ...getStyles2("root"), ...others, children: [
    label && (0, import_jsx_runtime290.jsx)("p", { ...getStyles2("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime290.jsxs)("svg", { width: size4, height: size4 / 2, ...getStyles2("svg"), children: [
...
function SimpleGridMediaVariables({
  ...
  return (0, import_jsx_runtime291.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return (0, import_jsx_runtime291.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  const props = useProps("SimpleGrid", defaultProps160, _props);
  const {
    classNames,
    className,
    style,
  ...
  const responsiveClassName = useRandomClassName();
  if (type === "container") {
    return (0, import_jsx_runtime292.jsxs)(import_jsx_runtime292.Fragment, { children: [
      (0, import_jsx_runtime292.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
      (0, import_jsx_runtime292.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime292.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime292.jsxs)(import_jsx_runtime292.Fragment, { children: [
    (0, import_jsx_runtime292.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime292.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  const props = useProps("Skeleton", defaultProps161, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime293.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react326.forwardRef)(
...
var Thumb3 = (0, import_react327.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react327.useState)(false);
    const isVisible = labelAlwaysOn || dragging || focused || showLabelOnHover && isHovered;
    return (0, import_jsx_runtime296.jsxs)(
      Box,
      {
        tabIndex: 0,
        role: "slider",
        ...
        children: [
          ...
          (0, import_jsx_runtime296.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime296.jsx)("div", { ...getStyles2("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset4, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react328.createElement)(
    Box,
    {
    ...
    mark.label && (0, import_jsx_runtime297.jsx)("div", { ...getStyles2("markLabel"), children: mark.label })
  ));
  return (0, import_jsx_runtime297.jsx)("div", { children: items });
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return (0, import_jsx_runtime298.jsx)(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime298.jsxs)(Box, { ...getStyles2("track"), mod: { inverted, disabled }, children: [
    ...
    children,
    (0, import_jsx_runtime298.jsx)(Marks, { ...others, offset: marksOffset, disabled, inverted })
  ] }) });
}
...
var Slider = factory((_props, ref) => {
  const props = useProps("Slider", defaultProps162, _props);
  const {
    classNames,
    styles,
    value,
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react330.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react330.useRef)(_value);
  const onChangeEndRef = (0, import_react330.useRef)(onChangeEnd);
  (0, import_react330.useEffect)(() => {
    onChangeEndRef.current = onChangeEnd;
  }, [onChangeEnd]);
  const root = (0, import_react330.useRef)(null);
  const thumb = (0, import_react330.useRef)(null);
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react330.useCallback)(
    ({ x }) => {
      if (!disabled) {
        ...
        setValue(
          restrictToMarks && (marks == null ? void 0 : marks.length) ? findClosestNumber(
            nextValue,
            marks.map((mark) => mark.value)
          ) : nextValue
        );
  ...
  const handleScrubEnd = (0, import_react330.useCallback)(() => {
    if (!disabled && onChangeEndRef.current) {
      const finalValue = restrictToMarks && (marks == null ? void 0 : marks.length) ? findClosestNumber(
        valueRef.current,
        marks.map((mark) => mark.value)
      ) : valueRef.current;
  ...
  const callOnChangeEnd = (0, import_react330.useCallback)(
    (value2) => {
      if (!disabled && onChangeEndRef.current) {
  ...
  return (0, import_jsx_runtime299.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime299.jsxs)(
    SliderRoot,
    {
      ...others,
      ...
      children: [
        (0, import_jsx_runtime299.jsx)(
          Track,
          {
            ...
            children: (0, import_jsx_runtime299.jsx)(
              Thumb3,
              {
                max: max2,
                min: min2,
        ...
        (0, import_jsx_runtime299.jsx)("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
      ]
    }
  ) });
});
...
var RangeSlider = factory((_props, ref) => {
  const props = useProps("RangeSlider", defaultProps163, _props);
  const {
    classNames,
    styles,
    value,
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react331.useState)(-1);
  const [hovered, setHovered] = (0, import_react331.useState)(false);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
  ...
  const valueRef = (0, import_react331.useRef)(_value);
  const thumbs = (0, import_react331.useRef)([]);
  const root = (0, import_react331.useRef)(null);
  const thumbIndex = (0, import_react331.useRef)(void 0);
  const positions = [
  ...
  const { ref: container, active } = useMove(
    ({ x }) => handleChange(x),
    { onScrubEnd: () => !disabled && (onChangeEnd == null ? void 0 : onChangeEnd(valueRef.current)) },
    dir
  );
  ...
  return (0, import_jsx_runtime300.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime300.jsxs)(
    SliderRoot,
    {
      ...others,
      size: size4,
      ...
      onKeyDownCapture: () => {
        var _a, _b, _c;
        if ((_b = (_a = thumbs.current[0]) == null ? void 0 : _a.parentElement) == null ? void 0 : _b.contains(document.activeElement)) {
          return;
        }
        (_c = thumbs.current[0]) == null ? void 0 : _c.focus();
      },
      children: [
            ...
            children: [
              (0, import_jsx_runtime300.jsx)(
                Thumb3,
                {
                  ...
                  isHovered: hovered,
                  disabled,
                  ...thumbProps == null ? void 0 : thumbProps(0),
              ...
              (0, import_jsx_runtime300.jsx)(
                Thumb3,
                {
                  ...
                  isHovered: hovered,
                  disabled,
                  ...thumbProps == null ? void 0 : thumbProps(1),
        ...
        (0, import_jsx_runtime300.jsx)("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }),
        (0, import_jsx_runtime300.jsx)("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })
      ]
    }
  ) });
});
...
var Space = factory((props, ref) => {
  const { w, h, miw, mih, ...others } = useProps("Space", defaultProps164, props);
  return (0, import_jsx_runtime301.jsx)(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  const props = useProps("Spoiler", defaultProps165, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime302.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      id: _id,
      ...
      ...others,
      children: [
        spoiler && (0, import_jsx_runtime302.jsx)(
          Anchor,
          {
            component: "button",
            type: "button",
        ...
        (0, import_jsx_runtime302.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime302.jsx)("div", { ref: contentRef, children })
          }
        )
      ]
    }
...
var Stack = factory((_props, ref) => {
  const props = useProps("Stack", defaultProps166, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime303.jsx)(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
var getStepFragment = (Fragment30, step) => {
  if (typeof Fragment30 === "function") {
    return (0, import_jsx_runtime305.jsx)(Fragment30, { step: step || 0 });
  }
  return Fragment30;
};
var defaultProps167 = {
...
var StepperStep = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("StepperStep", defaultProps167, props);
  ...
  return (0, import_jsx_runtime305.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        withIcon && (0, import_jsx_runtime305.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime305.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime305.jsx)(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime305.jsx)(
              "span",
              {
                ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi }),
                children: loading ? (0, import_jsx_runtime305.jsx)(
                  Loader,
                  {
                    color: "var(--mantine-color-white)",
                ...
                ) : getStepFragment(completedIcon, step) || (0, import_jsx_runtime305.jsx)(CheckIcon, { size: "60%" })
              }
            ) }),
            state !== "stepCompleted" ? loading ? (0, import_jsx_runtime305.jsx)(
              Loader,
              {
                ...ctx.getStyles("stepLoader", stylesApi),
                size: "calc(var(--stepper-icon-size) / 2)",
          ...
          orientation === "vertical" && (0, import_jsx_runtime305.jsx)(
            "span",
            {
        ...
        (label || description) && (0, import_jsx_runtime305.jsxs)(
          "span",
          {
            ...
            children: [
              label && (0, import_jsx_runtime305.jsx)("span", { ...ctx.getStyles("stepLabel", stylesApi), children: getStepFragment(label, step) }),
              description && (0, import_jsx_runtime305.jsx)("span", { ...ctx.getStyles("stepDescription", stylesApi), children: getStepFragment(description, step) })
            ]
          }
        )
      ]
...
var Stepper = factory((_props, ref) => {
  var _a, _b, _c;
  const props = useProps("Stepper", defaultProps168, _props);
  const {
    classNames,
    className,
    style,
  ...
  const convertedChildren = import_react337.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index5) => {
      ...
      acc.push(
        (0, import_react337.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index5 !== _children.length - 1) {
        acc.push(
          (0, import_react337.createElement)(
            "div",
            {
  ...
  return (0, import_jsx_runtime306.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime306.jsxs)(Box, { ...getStyles2("root"), ref, size: size4, ...others, children: [
    ...
    content && (0, import_jsx_runtime306.jsx)("div", { ...getStyles2("content"), children: content })
  ] }) });
});
...
var SwitchGroupContext = (0, import_react338.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react338.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps169, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime307.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime307.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime307.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
...
var Switch = factory((_props, ref) => {
  const props = useProps("Switch", defaultProps170, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime308.jsxs)(
    InlineInput,
    {
      ...getStyles2("root"),
      ...
      children: [
        ...
        (0, import_jsx_runtime308.jsxs)(
          Box,
          {
            ...
            ...getStyles2("track"),
            children: [
              (0, import_jsx_runtime308.jsx)(Box, { component: "span", mod: "reduce-motion", ...getStyles2("thumb"), children: thumbIcon }),
              (0, import_jsx_runtime308.jsx)("span", { ...getStyles2("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime311.jsxs)(import_jsx_runtime311.Fragment, { children: [
    data.caption && (0, import_jsx_runtime311.jsx)(TableCaption, { children: data.caption }),
    data.head && (0, import_jsx_runtime311.jsx)(TableThead, { children: (0, import_jsx_runtime311.jsx)(TableTr, { children: data.head.map((item, index5) => (0, import_jsx_runtime311.jsx)(TableTh, { children: item }, index5)) }) }),
    data.body && (0, import_jsx_runtime311.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime311.jsx)(TableTr, { children: row.map((item, index5) => (0, import_jsx_runtime311.jsx)(TableTd, { children: item }, index5)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime311.jsx)(TableTfoot, { children: (0, import_jsx_runtime311.jsx)(TableTr, { children: data.foot.map((item, index5) => (0, import_jsx_runtime311.jsx)(TableTh, { children: item }, index5)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  const props = useProps("TableScrollContainer", defaultProps171, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime312.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime312.jsx)("div", { ...getStyles2("scrollContainerInner"), children })
    }
  );
});
...
var Table = factory((_props, ref) => {
  const props = useProps("Table", defaultProps172, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime313.jsx)(
    TableProvider,
    {
      value: {
        getStyles: getStyles2,
      ...
      children: (0, import_jsx_runtime313.jsx)(
        Box,
        {
          component: "table",
          variant,
          ...
          ...getStyles2("table"),
          ...others,
          children: children || !!data && (0, import_jsx_runtime313.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TableOfContents = factory((_props, ref) => {
  const props = useProps("TableOfContents", defaultProps173, _props);
  const {
    classNames,
    className,
    style,
  ...
  const controls = headingsData.map((data, index5) => {
    const controlProps = getControlProps == null ? void 0 : getControlProps({
    ...
    return (0, import_jsx_runtime314.jsx)(
      UnstyledButton,
      {
        ...
        ...controlProps,
        ...getStyles2("control", {
          className: controlProps == null ? void 0 : controlProps.className,
          style: controlProps == null ? void 0 : controlProps.style
        })
      },
      data.id || `${idBase}-${index5}`
    );
  });
  return (0, import_jsx_runtime314.jsx)(Box, { ref, variant, ...getStyles2("root"), ...others, children: controls });
});
...
var classes82 = { "root": "m_89d60db1", "list--default": "m_576c9d4", "list": "m_89d33d6d", "panel": "m_b0c91715", "tab": "m_4ec4dce6", "tabSection": "m_fc420b1f", "tab--default": "m_539e827b", "list--outline": "m_6772fbd5", "tab--outline": "m_b59ab47c", "tab--pills": "m_c3381914" };

// node_modules/@mantine/core/esm/components/Tabs/TabsList/TabsList.mjs
var defaultProps174 = {};
var TabsList = factory((_props, ref) => {
  const props = useProps("TabsList", defaultProps174, _props);
...
var TabsPanel = factory((_props, ref) => {
  const props = useProps("TabsPanel", defaultProps175, _props);
  ...
  return (0, import_jsx_runtime317.jsx)(
    Box,
    {
      ...others,
      ...ctx.getStyles("panel", {
...
var TabsTab = factory((_props, ref) => {
  const props = useProps("TabsTab", defaultProps176, _props);
  const {
    className,
    children,
    rightSection,
  ...
  return (0, import_jsx_runtime318.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime318.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime318.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children }),
        rightSection && (0, import_jsx_runtime318.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Tabs = factory((_props, ref) => {
  const props = useProps("Tabs", defaultProps177, _props);
  const {
    defaultValue,
    value,
    onChange,
  ...
  return (0, import_jsx_runtime319.jsx)(
    TabsProvider,
    {
      ...
      children: (0, import_jsx_runtime319.jsx)(
        Box,
        {
          ref,
          id: uid,
...
var TagsInput = factory((_props, ref) => {
  const props = useProps("TagsInput", defaultProps178, _props);
  const {
    classNames,
    className,
    style,
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react352.useRef)(null);
  ...
  const values2 = _value.map((item, index5) => (0, import_jsx_runtime321.jsx)(
    Pill,
    {
  ...
  const clearButton = (0, import_jsx_runtime321.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime321.jsxs)(import_jsx_runtime321.Fragment, { children: [
    (0, import_jsx_runtime321.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime321.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime321.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              id: _id,
              mod,
              children: (0, import_jsx_runtime321.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime321.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime321.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  const _props = useProps("TextInput", defaultProps179, props);
  return (0, import_jsx_runtime322.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  const props = useProps("ThemeIcon", defaultProps180, _props);
  ...
  return (0, import_jsx_runtime323.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var TimelineItem = factory((_props, ref) => {
  const props = useProps("TimelineItem", defaultProps181, _props);
  const {
    classNames,
    className,
    style,
  ...
  const theme = useMantineTheme();
  const stylesApiProps = { classNames, styles };
  return (0, import_jsx_runtime325.jsxs)(
    Box,
    {
      ...ctx.getStyles("item", { ...stylesApiProps, className, style }),
      ...
      children: [
        ...
        (0, import_jsx_runtime325.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          title && (0, import_jsx_runtime325.jsx)("div", { ...ctx.getStyles("itemTitle", stylesApiProps), children: title }),
          (0, import_jsx_runtime325.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  const props = useProps("Timeline", defaultProps182, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _children = import_react357.Children.toArray(children);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react357.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return (0, import_jsx_runtime326.jsx)(TimelineProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime326.jsx)(Box, { ...getStyles2("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
...
var Title = factory((_props, ref) => {
  const props = useProps("Title", defaultProps183, _props);
  const {
    classNames,
    className,
    style,
...
function TreeNode({
  ...
  const ref = (0, import_react360.useRef)(null);
  const nested = (node.children || []).map((child) => (0, import_jsx_runtime329.jsx)(
    TreeNode,
    {
      node: child,
      flatValues,
  ...
  return (0, import_jsx_runtime329.jsxs)(
    "li",
    {
      ...getStyles2("node", {
      ...
      children: [
        typeof renderNode === "function" ? renderNode({
          ...
          elementProps
        }) : (0, import_jsx_runtime329.jsx)("div", { ...elementProps, children: node.label }),
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime329.jsx)("ul", { role: "group", ...getStyles2("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
function useTree({
  ...
  const [data, setData] = (0, import_react363.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react363.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react363.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react363.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react363.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react363.useState)(null);
  const initialize = (0, import_react363.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react363.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react363.useCallback)(
    (value) => {
      setExpandedState((current) => {
        if (current[value] !== false) {
          onNodeCollapse == null ? void 0 : onNodeCollapse(value);
        }
  ...
  const expand = (0, import_react363.useCallback)(
    (value) => {
      setExpandedState((current) => {
        if (current[value] !== true) {
          onNodeExpand == null ? void 0 : onNodeExpand(value);
        }
  ...
  const expandAllNodes = (0, import_react363.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react363.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react363.useCallback)(
  ...
  const select = (0, import_react363.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react363.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react363.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react363.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react363.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react363.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react363.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  const props = useProps("Tree", defaultProps184, _props);
  const {
    classNames,
    className,
    style,
  ...
  const flatValues = (0, import_react364.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react364.useEffect)(() => {
    controller.initialize(data);
  }, [data]);
  const nodes = data.map((node, index5) => (0, import_jsx_runtime332.jsx)(
    TreeNode,
    {
      node,
      getStyles: getStyles2,
  ...
  return (0, import_jsx_runtime332.jsx)(
    Box,
    {
      component: "ul",
      ref: mergedRef,
...
var classes87 = { "root": "m_d6493fad" };

// node_modules/@mantine/core/esm/components/TypographyStylesProvider/TypographyStylesProvider.mjs
var defaultProps185 = {};
var TypographyStylesProvider = factory((_props, ref) => {
  const props = useProps("TypographyStylesProvider", defaultProps185, _props);
...
TypographyStylesProvider.classes = classes87;
